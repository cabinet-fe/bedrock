...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    DashboardTaskOverviewCard: typeof import('./src/components/dashboard-task-overview-card/dashboard-task-overview-card.vue')['default']
    DashboardWidgetHost: typeof import('./src/components/dashboard-grid/dashboard-widget-host.vue')['default']
    DocViewerPanel: typeof import('./src/components/ai-chat/panels/doc-viewer-panel.vue')['default']
    ...
    ThemeSwitcher: typeof import('./src/components/theme-switcher/theme-switcher.vue')['default']
