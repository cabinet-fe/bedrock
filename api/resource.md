...
| `name` | `string` |  |  |
| `token_prefix` | `string` |  |  |
| `scopes` | `('skills:read' \| 'agents:run' \| 'docs:read' \| 'docs:write' \| 'dev_docs:read' \| 'dev_docs:write' \| 'builds:run' \| 'pipelines:run' \| 'scripts:run' \| 'bugs:read' \| 'bugs:write')[]` |  |  |
