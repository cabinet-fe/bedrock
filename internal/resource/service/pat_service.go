...
var (
	...
	ErrPATBadScope    = errors.New("scope 仅允许 skills:read、agents:run、docs:read、docs:write、dev_docs:read、dev_docs:write、builds:run、pipelines:run、scripts:run、bugs:read、bugs:write")
...
func normalizeScopes(scopes []string) ([]string, error) {
	...
	for _, sc := range scopes {
		...
		case model.ScopeSkillsRead, model.ScopeAgentsRun, model.ScopeDocsRead, model.ScopeDocsWrite,
			...
			model.ScopeBugsRead, model.ScopeBugsWrite:
		default:
			return nil, ErrPATBadScope
		}
		if !seen[sc] {
